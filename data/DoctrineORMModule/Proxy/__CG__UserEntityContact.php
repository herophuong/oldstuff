 ...
 */
class Contact extends \User\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'contact_id', 'address', 'city', 'state', 'zipcode', 'country', 'phone');
        }
